                        ...
                        <!-- <div class="form-group last"> -->
                            ...
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                ...
                                <div class="m-bot15">
                                    ...
                                    <button type="submit" name="download" class="btn btn-primary fileupload-exists"><i class="fa fa-download"></i> Загрузить</button> 
                                </div>
                            </div>
                        <!-- </div> -->
                    </form>
                        ...
                        <div class="col-md-12">
                            ...
                            foreach ($ex_file as $item) {
                                ...
                                <div class="fileupload-new thumbnail modal-in">                                                
                                    ...
                                    <div class="modal-con">
                                        <a class="modal-link" onclick=" copy_urlb('<?php if ($item['type']==1) echo  base_url('assets/documents/'.$item['fail']); else echo  base_url('assets/images/photos/'.$item['fail']); ?>');"><i class="fa fa-link" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                                <?php
                            }
