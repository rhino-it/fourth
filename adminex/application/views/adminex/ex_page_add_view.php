                        ...
                        <div class="panel-body">
                            <div class="tab-content">                            
                                ...
                                <div id="copy" class="tab-pane active">      
                                    ...
                                    <center>
                                        <span class="btn btn-default btn-file m-bot15">
                                            <input type="file" multiple="multiple" accept="image/*" id="sortpicture" name="sortpic">
                                        </span><br>
                                        
                                        <span style="display: inline-block" class="m-bot15">Максимальный размер файла 3 МБайт</span><br>
                                        
                                        <button id="upload" type="button" name="download" class="btn btn-primary fileupload-exists"><i class="fa fa-download"></i> Загрузить</button>   
                                    
                                    </center>
                                    </form> 
                                </div>

                                <div id="media" class="tab-pane">      </div>
